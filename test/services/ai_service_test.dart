...
void main() {
  ...
  group('AIService parseApiResponse', () {
    test('parses valid Paris mock JSON correctly', () {
      ...
      // TODO: Verify latitude access on TripModel
      // expect(trip.latitude, 48.8566);
      // TODO: Verify longitude access on TripModel
    ...
    test('parses generic mock JSON correctly', () {
      ...
      final mockGenericResponse = {
        ...
        "is_public": false,
        "description":
            "A wonderful ${preferences['duration']}-day trip to ${preferences['destination']}.",
        "cover_image_url":
        ...
        "days": List.generate(
          ...
          (index) => {
            ...
            "activities": [
              {
                "title": "Morning Rock Gazing",
                "description": "Look at rocks.",
                "location_name": "Big Rock Area",
                "time": "10:00",
              },
              {
                "title": "Martian Lunch",
                "description": "Eat space food.",
                "location_name": "Crater Diner",
                "time": "13:00",
              },
            ],
          },
